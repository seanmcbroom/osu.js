...
class User {
    ...
    async getBestScores() {
        return new Promise((resolve) => {
            this.osu.apiCall('/get_user_best', { u: this.user_id, type: 'id', m: 0, limit: 100 })
                .then(async scores => {
    ...
    async getScores(options = {}) {
        ...
        return new Promise((resolve) => {
            this.osu.apiCall('/get_scores', { b: beatmapId, u: this.user_id, type: 'id', m: 0 })
                .then(async scores => {
                    if (scores.length <= 0) return resolve(null);
    ...
    async getRecent(options = {}) {
        ...
        return new Promise((resolve) => {
            this.osu.apiCall('/get_user_recent', { m: 0, limit: (filter == 'recent') ? 1 : 50, u: this.user_id, type: 'id' })
